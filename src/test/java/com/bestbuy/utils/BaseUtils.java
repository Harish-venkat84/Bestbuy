...
public class BaseUtils {
	...
	public void typeText(WebElement element,String text, String pass, String fail) {

		try { 
				element.sendKeys(text); 
				
				Reports.reportStep(Status.PASS, pass);
				
		}catch(Exception ex) {
			
			new CustomException(fail, ex);
			
			Reports.reportStep(Status.FAIL, fail);
	...
	public void clickElement(WebElement element, String pass, String fail) {
		
		try { element.click(); Reports.reportStep(Status.PASS, pass);}catch (Exception ex) {
